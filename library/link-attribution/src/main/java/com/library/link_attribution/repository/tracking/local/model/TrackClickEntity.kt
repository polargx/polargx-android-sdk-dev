package com.library.link_attribution.repository.tracking.local.model
...
data class TrackClickEntity(
    ...
    companion object {
        fun TrackClickModel.toEntity(): TrackClickEntity {
            return TrackClickEntity(
                unid = unid,
                createdAt = createdAt,
                updatedAt = updatedAt,
                email = email,
    ...
    fun toExternal(): TrackClickModel {
        return TrackClickModel(
            unid = unid,
            createdAt = createdAt,
            updatedAt = updatedAt,
            email = email,
